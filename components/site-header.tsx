              ...
              <div className="p-4 sm:p-6 h-full overflow-y-auto">
                ...
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                  <div className="flex items-center gap-4">
                    <Image src="/Elmsaleaclean.png" alt="Elmsalea Clean" width={64} height={64} className="rounded-full" />
                    <div>
                      <h2 className="font-bold text-[#1E293B] text-sm sm:text-base">Elmsalea clean </h2>
