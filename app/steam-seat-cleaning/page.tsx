...
export const metadata: Metadata = {
  title: "غسيل مراتب السيارة بالبخار بالرياض - تنظيف عميق وتعقيم | Elmsalea clean",
  description:
    "أفضل خدمة غسيل مراتب السيارة بالبخار في الرياض. تنظيف عميق، إزالة البقع الصعبة، تعقيم شامل. خدمة متنقلة احترافية. اتصل الآن 0545915592",
  keywords:
    "غسيل مراتب السيارة بالبخار, تنظيف مراتب السيارة الرياض, غسيل مقاعد السيارة, تعقيم مراتب السيارة, إزالة بقع المراتب",
  openGraph: {
    title: "غسيل مراتب السيارة بالبخار بالرياض | Elmsalea clean",
    description: "تنظيف عميق وتعقيم شامل لمراتب السيارة بالبخار. إزالة البقع الصعبة، خدمة متنقلة احترافية.",
    url: "https://elmsaleaclean.com/steam-seat-cleaning",
    images: [{ url: "/services/seat-cleaning-og.jpg", width: 1200, height: 630 }],
  },
  alternates: {
    canonical: "https://elmsaleaclean.com/steam-seat-cleaning",
  },
}
