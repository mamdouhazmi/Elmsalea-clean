...
export const metadata: Metadata = {
  title: "غسيل سيارات بالبخار متنقل بالرياض - خدمة في موقعك | Elmsalea clean",
  description:
    "أفضل خدمة غسيل سيارات بالبخار متنقل في الرياض. تنظيف داخلي وخارجي، تعقيم شامل، خدمة في موقعك. متاح 24/7 - اتصل 0565654734",
  keywords:
    "غسيل سيارات بالبخار متنقل, غسيل سيارات عند البيت, مغسلة سيارات متنقلة الرياض, غسيل سيارات بالبخار الرياض, تنظيف سيارات متنقل",
  openGraph: {
    title: "غسيل سيارات بالبخار متنقل بالرياض | Elmsalea clean",
    description: "خدمة غسيل سيارات بالبخار متنقلة احترافية. تنظيف داخلي وخارجي، تعقيم شامل في موقعك.",
    url: "https://elmsaleaclean.com/mobile-steam-cleaning",
    images: [{ url: "/services/mobile-wash-og.jpg", width: 1200, height: 630 }],
  },
  alternates: {
    canonical: "https://elmsaleaclean.com/mobile-steam-cleaning",
  },
}
