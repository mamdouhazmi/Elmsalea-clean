...
export const metadata: Metadata = {
  title: "تلميع سيارات بالرياض - خدمة تلميع داخلي وخارجي احترافية | Elmsalea clean",
  description:
    "أفضل شركة تلميع سيارات بالرياض. خدمة تلميع داخلي وخارجي احترافية، إزالة الخدوش، تلميع المقاعد والديكورات. خصم 30% - اتصل الآن 0565654734",
  keywords:
    "تلميع سيارات الرياض, تلميع سيارات داخلي, تلميع سيارات خارجي, شركة تلميع سيارات, تلميع مقاعد السيارة, إزالة خدوش السيارة",
  openGraph: {
    title: "تلميع سيارات بالرياض - خدمة احترافية | Elmsalea clean",
    description: "أفضل شركة تلميع سيارات بالرياض. تلميع داخلي وخارجي، إزالة الخدوش، نتائج مضمونة. خصم 30%",
    url: "https://elmsaleaclean.com/car-polishing",
    images: [{ url: "/services/service-polishing-og.jpg", width: 1200, height: 630 }],
  },
  alternates: {
    canonical: "https://elmsaleaclean.com/car-polishing",
  },
}
