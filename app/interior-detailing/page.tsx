...
export const metadata: Metadata = {
  title: "تلميع سيارات متنقل الرياض - خدمة تلميع داخلي وخارجي في موقعك | Elmsalea clean",
  description:
    "أفضل شركة تلميع سيارات متنقل بالرياض. خدمة تلميع داخلي وخارجي في موقعك، تنظيف المقاعد، تلميع الديكورات. متاح 24/7 - اتصل 0565654734",
  keywords:
    "تلميع سيارات متنقل الرياض, تلميع سيارات في البيت, تلميع سيارات داخلي متنقل, شركة تلميع متنقلة, تلميع سيارات عند البيت",
  openGraph: {
    title: "تلميع سيارات متنقل الرياض - خدمة في موقعك | Elmsalea clean",
    description: "خدمة تلميع سيارات متنقلة احترافية في الرياض. تلميع داخلي وخارجي في موقعك، نتائج مضمونة.",
    url: "https://elmsaleaclean.com/interior-detailing",
    images: [{ url: "/services/mobile-detailing-og.jpg", width: 1200, height: 630 }],
  },
  alternates: {
    canonical: "https://elmsaleaclean.com/interior-detailing",
  },
}
