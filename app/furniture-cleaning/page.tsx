...
export const metadata: Metadata = {
  title: "تنظيف المجالس والكنب بالرياض - غسيل بالبخار وإزالة البقع | Elmsalea clean",
  description:
    "أفضل شركة تنظيف المجالس والكنب والسجاد بالرياض. غسيل بالبخار، إزالة البقع الصعبة، تعقيم شامل. خدمة متنقلة احترافية - اتصل 0565654734",
  keywords:
    "تنظيف المجالس بالرياض, غسيل الكنب بالبخار, تنظيف السجاد والموكيت, شركة تنظيف مفروشات, غسيل الستائر بالبخار",
  openGraph: {
    title: "تنظيف المجالس والكنب بالرياض - غسيل بالبخار | Elmsalea clean",
    description: "خدمة تنظيف المجالس والكنب والسجاد بالبخار. إزالة البقع الصعبة، تعقيم شامل، نتائج مضمونة.",
    url: "https://elmsaleaclean.com/furniture-cleaning",
    images: [{ url: "/services/furniture-cleaning-og.jpg", width: 1200, height: 630 }],
  },
  alternates: {
    canonical: "https://elmsaleaclean.com/furniture-cleaning",
  },
}
